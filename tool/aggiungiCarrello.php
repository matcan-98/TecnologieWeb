    ...
    if(($id!=$e1)&&($id!=$e2)&&($id!=$e3)&&($id!=$e4)&&($id!=$e5)&&($id!=$e6)&&($id!=$e7)&&($id!=$e8)&&($id!=$e9)&&($id!=$e10)){
      if(mysqli_num_rows($res_Event) > 0){
              while($row = mysqli_fetch_array($res_Event)){
                switch($row['e_stored']){
                  case '0':
                          $sql_Cart = "UPDATE `carrello` SET `e1` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '1' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '1':
                          $sql_Cart = "UPDATE `carrello` SET `e2` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '2' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '2':
                          $sql_Cart = "UPDATE `carrello` SET `e3` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '3' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '3':
                          $sql_Cart = "UPDATE `carrello` SET `e4` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '4' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '4':
                          $sql_Cart = "UPDATE `carrello` SET `e5` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '5' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '5':
                          $sql_Cart = "UPDATE `carrello` SET `e6` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '6' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '6':
                          $sql_Cart = "UPDATE `carrello` SET `e7` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '7' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '7':
                          $sql_Cart = "UPDATE `carrello` SET `e8` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '8' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '8':
                          $sql_Cart = "UPDATE `carrello` SET `e9` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '9' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '9':
                          $sql_Cart = "UPDATE `carrello` SET `e10` = '$id' WHERE `carrello`.`Mail` = '$Mail'";
                          $sql_Cart2 = "UPDATE `carrello` SET `e_stored` = '10' WHERE `carrello`.`Mail` = '$Mail'";
                  break;
                  case '10':
      ...
      $_SESSION['FULLCART']="Evento Gia Presente Nel Carrello";
        echo '<script> location.replace("../event.php"); </script>';
  }
