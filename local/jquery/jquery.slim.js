...
// Microsoft forgot to hump their local prefix (#9572)
...
// Return a local-prefixed property or undefined
function localPropName( name ) {

	// Check for local prefixed names
...
// Return a potentially-mapped jQuery.cssProps or local prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || localProps[ name ];
	...
	return localProps[ name ] = localPropName( name ) || name;
}
