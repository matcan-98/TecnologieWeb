...
<br/><br/>
                  <li class="active"><a href="#"><span class="badge pull-right"><span class=""></span><?php echo $event_price."€";?></span> Final Payment</a>
                  </li>

              </ul>
              <br/>  <br/>
              <a href="tool/buy.php<?php echo"$payThat"; ?>" class="btn btn-success btn-lg btn-block" role="button">Pay</a>
              <br/><br/>
