...
$update_query = "SELECT * FROM commentso WHERE mail='$Mail'";
...
if($_POST["view"] != '')
{
    ...
    $update_query = "UPDATE commentso SET vistada='$concat'";
    mysqli_query($con, $update_query);
}
$query = "SELECT * FROM commentso ORDER BY comment_id DESC LIMIT 6";
...
$status_query = "SELECT * FROM commentso WHERE mail='$Mail'";
