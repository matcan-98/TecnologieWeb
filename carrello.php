...
<?php
include 'tool/php/carrello_tool_2.php';
?>
</head>
<body>
...
<?php
include 'tool/php/carrello_tool.php';
?>
    <div class="row">
  ...
  <div id="modify" class="overlay">
      <div class="popup">
          <h2>Modifica</h2>
          <a class="close" href="carrello.php">&times;</a>
          <div class="content">
            modifica riuscita correttamente
          </div>
          <br/>
            <a class="btn btn-warning" href="carrello.php">Continua</a>
      </div>
  </div>
  <div id="creato" class="overlay">
      <div class="popup">
          <h2>Evento Creato</h2>
          <a class="close" href="carrello.php">&times;</a>
          <div class="content">
  ...
  <div id="delete" class="overlay">
      <div class="popup">
          ...
          <a class="close" href="carrello.php">&times;</a>
          <div class="content">
            evento cancellato correttamente
          </div>
          <br/>
            <a class="btn btn-warning" href="carrello.php">Continua</a>
      </div>
